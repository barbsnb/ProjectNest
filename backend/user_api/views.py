...
class UserVisit(APIView):
    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            change_status_url = request.build_absolute_uri(f'/api/change_status/{visit_id}/')
...
class ChangeStatus(APIView):
    ...
    def send_status_changed_email(self, request, guest_email, visit):
        ...
        complete_visit_url = request.build_absolute_uri(f'/api/complete_visit/{visit.id}/')
        message = f"Status for your visit {visit.id} has been changed to inprogress.\n\n" \
