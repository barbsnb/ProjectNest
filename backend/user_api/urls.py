...
urlpatterns = [
    ...
    path("change_status/<int:visit_id>/", views.ChangeStatus.as_view(), name="change_status"),
    path("complete_visit/<int:visit_id>/", views.CompleteVisit.as_view(), name="complete_visit"),
]
